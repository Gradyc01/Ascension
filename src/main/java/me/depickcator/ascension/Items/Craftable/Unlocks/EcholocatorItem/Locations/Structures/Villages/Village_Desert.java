...
public class Village_Desert extends EcholocatorLocations {
    public Village_Desert() {
        super("Village: Desert", Structure.VILLAGE_DESERT, Ascension.getInstance().getWorld());
    }
