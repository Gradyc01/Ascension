...
public class Village_Savanna extends EcholocatorLocations {
    public Village_Savanna() {
        super("Village: Savanna", Structure.VILLAGE_SAVANNA, Ascension.getInstance().getWorld());
    }
