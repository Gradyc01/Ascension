...
public abstract class ViewRecipeGUIs extends AscensionMenuGUI {
    ...
    public ViewRecipeGUIs(PlayerData playerData, char GUILines, Component name, Recipe recipe) {
        super(playerData, GUILines, name, true);
        displayMap = initDisplayMap();
        makeRecipeGUI(recipe);
    ...
    private void makeRecipeGUI(Recipe recipe) {
