...
public class BackpackGUI2 extends AscensionGUI {

    public BackpackGUI2(PlayerData playerData, int backpackLevel) {
        super(playerData,
    ...
    public BackpackGUI2(PlayerData playerData, int backpackLevel, Inventory inventory) {
